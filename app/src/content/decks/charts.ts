...
export const chartsDeck = deck(
  ...
  [
    ...
    },
    {
      ...
      front: 'Small **glider / hang glider / ultralight** symbols near a field mean what for you?',
    ...
    {
      slug: 'tac',
      front: 'When should you fly with the **Terminal Area Chart** instead of the sectional?',
      back: 'Operating near a Class B — TACs are 1:250,000 (double the sectional’s detail) and show the Bravo shelves, VFR corridors, and reporting points clearly. Seattle has one.',
      cite: 'FAA Chart Users’ Guide',
    },
    {
      slug: 'flyway',
      front: 'What’s printed on the BACK of the Seattle TAC?',
      back: 'The VFR Flyway Planning Chart — recommended routes and altitudes for threading around/under the Bravo without a clearance.',
      cite: 'FAA Chart Users’ Guide',
      unverified: true,
    },
    {
      slug: 'obst-group',
      front: 'Two obstruction symbols drawn **side-by-side, joined at the base**?',
      back: 'A group obstruction — multiple towers at that location; the height shown is the tallest.',
      cite: 'FAA Chart Users’ Guide',
      unverified: true,
    },
    {
      slug: 'wind-turbine',
      front: 'Fields of tiny **windmill symbols** on the chart?',
      back: 'Wind turbine farms — treat as a single obstruction area at the charted height; turbulence downwind of them is real at low altitude.',
      cite: 'FAA Chart Users’ Guide',
    },
    {
      slug: 'seaplane',
      front: 'An anchor inside the airport circle means?',
      back: 'A seaplane base (Lake Washington and Lake Union have them — active floatplane traffic below you around Seattle).',
      cite: 'FAA Chart Users’ Guide',
      unverified: true,
    },
    {
      slug: 'private-r',
      front: 'How do you spot an airport you may NOT casually use?',
      back: '“(Pvt)” after the name — private, prior permission required. It may still be your best option in an emergency; 91.3 outranks courtesy.',
      cite: 'FAA Chart Users’ Guide',
    },
    {
      slug: 'services-legend',
      front: 'Where on the paper chart do you decode any symbol you don’t know?',
      back: 'The chart legend panel — every symbol on the face is decoded there. On the knowledge test, the legend is provided in the supplement book; USE it.',
      cite: 'FAA Chart Users’ Guide; testing supplement',
    },
    {
      slug: 'wac-scale',
