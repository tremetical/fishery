...
export const performanceDeck = deck(
  ...
  [
    ...
    {
      slug: 'chart-method',
      front: 'The disciplined way to work any POH **takeoff/landing chart**?',
      back: 'Write down every input first (PA, temp, weight, wind, surface), follow the chart’s own example line, apply notes/corrections IN THE ORDER the chart states, then sanity-check the result against experience.',
      why: 'Chart notes (“add 15% for dry grass”) are where the exam hides the right answer.',
      cite: 'POH Section 5',
    },
    {
      slug: 'climb-gradient',
      front: 'Climb RATE vs climb GRADIENT — which one clears the obstacle?',
      back: 'Gradient (feet per ground mile) clears obstacles — it depends on groundspeed, so a headwind steepens your path over the ground even at the same rate.',
      cite: 'PHAK Ch. 11',
    },
    {
      slug: 'power-settings',
      front: 'Typical cruise power settings and their trade?',
      back: '75%: fastest, thirstiest. 65%: the usual compromise. 55%: slow, maximum range/endurance territory. The POH cruise table prices each.',
      cite: 'POH Section 5',
    },
    {
      slug: 'hydroplane',
      front: 'Rule-of-thumb **hydroplaning** speed?',
      back: '≈ 9 × √(tire pressure in psi). A trainer tire at 36 psi hydroplanes around 54 kt — landing speed, on a wet runway.',
      why: 'Above it, braking and steering go to near zero. Firm touchdown, aerodynamic braking, patience.',
      cite: 'AC 91-79; PHAK',
      unverified: true,
    },
    {
      slug: 'wind-components-90',
      front: 'Crosswind rules of thumb by angle off the runway?',
      back: '15° → ~25% of the wind · 30° → 50% · 45° → 70% · 60°+ → treat as 100%. (Clock trick: minutes past the hour ≈ fraction.)',
      cite: 'PHAK Ch. 11',
    },
    {
      slug: 'demo-crosswind',
      front: 'What IS the POH’s “maximum demonstrated crosswind component”?',
      back: 'The strongest crosswind a test pilot happened to demonstrate during certification — NOT a limitation, but exceeding it makes you the new test pilot.',
      cite: 'POH Section 4; PHAK',
    },
    {
      slug: 'da-rule-thumb',
      front: 'Quick density-altitude estimate without a chart?',
      back: 'DA ≈ pressure altitude + 120 × (OAT°C − ISA temp). Field at 1,500 PA on a 30°C day (ISA ~12°): 1,500 + 120×18 ≈ 3,700 ft DA.',
      cite: 'PHAK Ch. 11',
    },
    {
