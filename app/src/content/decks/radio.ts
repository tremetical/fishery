...
const phrasCards: (Omit<Card, 'id'> & { slug: string })[] = [
  ...
  {
    slug: 'flight-following-req',
    front: 'How do you ask for **VFR flight following**, and what info will they want?',
    back: '“Seattle Approach, Skyhawk 731TW, VFR request.” Then: position, altitude, type, destination. You’ll get a squawk and traffic advisories, workload permitting.',
    cite: 'AIM 4-1-15',
  },
  {
    slug: 'radar-contact',
    front: 'ATC says **“radar contact.”** What does it mean — and NOT mean?',
    back: 'They see your target and will provide radar services. It does NOT mean they’re navigating for you or separating you from VFR traffic — see-and-avoid still rules.',
    cite: 'P/CG “RADAR CONTACT”',
  },
  {
    slug: 'freq-change',
    front: 'Leaving a tower’s airspace VFR — must you ask to change frequency?',
    back: 'Departing Class D, no request needed once clear (courtesy call helps). With flight following, ask (“request frequency change”) or wait for “radar service terminated, squawk VFR.”',
    cite: 'AIM 4-2-3; 4-1-15',
    unverified: true,
  },
  {
    slug: 'common-freqs',
    front: 'Frequencies to know cold: **UNICOM at a towered field, FSS, MULTICOM**?',
    back: 'UNICOM often 122.95 at towered airports (fuel, services); FSS 122.2 (plus charted RCOs); MULTICOM 122.9 for fields with no facility at all.',
    cite: 'AIM 4-1-9, 4-1-11',
    unverified: true,
  },
  {
    slug: 'position-report-vfr',
    front: 'Structure of an en-route **position report** to FSS or on CTAF while transiting?',
    back: 'Who you are, where (fix/landmark + altitude), intentions: “Skyhawk 731TW, over the Narrows Bridge at three thousand five hundred, northbound for Paine.”',
    cite: 'AIM 4-2-3',
  },
  {
    slug: 'ident-button',
    front: 'ATC: “Skyhawk 1TW, **ident**.” What do you do — and never do?',
    back: 'Press the IDENT button on the transponder (your target blooms on scope). Never press it unrequested.',
    cite: 'AIM 4-1-20; P/CG “IDENT”',
  },
  {
    slug: 'say-altitude',
    front: '“Say altitude” and “say intentions” — what are these really checking?',
    back: 'Verifying Mode C accuracy and your plan. Answer in the required form: “four thousand five hundred, Skyhawk 1TW” — short, exact, callsign at the end.',
    cite: 'AIM 4-1-20',
  },
  {
    slug: 'blocked-stuck-mic',
    front: 'The frequency has gone strangely silent for minutes. What might YOU be causing?',
    back: 'A stuck mic — your PTT jammed transmitting, blocking everyone. Check the switch and your headset plugs; ATC may be calling you on 121.5.',
    cite: 'AIM 4-2-2',
  },
  {
    slug: 'atis-code-use',
    front: 'Why does the tower care that you “have information **Bravo**”?',
    back: 'The phonetic ATIS letter proves which hourly snapshot you heard — wrong or missing letter and they must read you the current weather/runway. Update when the letter rolls.',
    cite: 'AIM 4-1-13',
  },
  {
    slug: 'who-first',
